...
export default function Page() {
  ...
  const games: GameItem[] = [
    { id: 3, title: 'A CONTA PERFEITA PRA VOCÊ!', price: 'R$ 10,00', priceNumber: 10, oldPrice: 'R$ 85,99', discount: '80%', description: ['Yamal | Ronaldinho | Pelé', 'Conta perfeita e custo beneficio', 'Zaga excelente', '3290 de Força Coletiva'], images: ['https://i.imgur.com/lYI2AtW.png','https://i.imgur.com/YkxXjBe.png','https://i.imgur.com/naD4Fqh.png','https://i.imgur.com/naD4Fqh.png'], checkout: '' },
